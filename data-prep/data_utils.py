...
def get_embedding(text, embedding_model_endpoint=None, embedding_model_key=None, azure_credential=None):
    ...
    # Shelly note: limiting to V2 as suggested by support
    FLAG_AOAI = "V2"
...
def process_file(
    ...
    try:
        ...
        if url_prefix:
            ...
            # Shelly note: this is to remove the additional suffix
            url_path = url_path.removesuffix(".md").removesuffix("index.html").removesuffix(".txt")
